...
<!-- <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active sizeimg " data-bs-interval="2000">
      <img src="img/banner2.2.jpg" class="banner d-block w-100 img-fluid" alt="...">
    </div>
    <div class="carousel-item sizeimg"data-bs-interval="2000">
      <img src="img/bannieve.jpg" class="banner d-block w-100 img-fluid" alt="...">
    </div>
    <div class="carousel-item sizeimg"data-bs-interval="2000">
      <img src="img/baner3.jpg" class="banner d-block w-100 img-fluid" alt="...">
    </div>
  </div>
</div> -->
